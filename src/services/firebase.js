...
class Firebase {
  constructor() {
    ...
    this.auth = app.auth();
    const arrayRemove = app.firestore.FieldValue.arrayRemove;
  }
  ...
  saveBasketItems = (items, userId) =>
    ...
    // Remove Basket Item Change Ak.
  removeBasketItems = (items, userId) => 
    this.db.collection('users').doc(userId).update({basket: arrayRemove(items)});
  ...
  // // Payment ACTIONS ----
  addPayment = () =>
    this.db.collection('payment').doc(id).set(payment);
}
